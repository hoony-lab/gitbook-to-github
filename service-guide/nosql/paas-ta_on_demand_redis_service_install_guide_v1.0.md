# PAAS-TA\_ON\_DEMAND\_REDIS\_SERVICE\_INSTALL\_GUIDE\_V1.0
...
본 문서의 설치된 시스템 구성도이다. Redis, MariaDB, On-Demand 서비스 브로커로 최소사항을 구성하였다. ![](../../.gitbook/assets/redis_image_01.png)
